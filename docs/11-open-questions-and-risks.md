...
|---|---|---|---|---|
| Q1 | **IVR / telephony vendor?** (PRD §23) | ✅ **DECIDED (24-Jul-2026): support all four — Exotel, Knowlarity, Ozonetel, MyOperator** as tenant-selectable adapters. Each agency picks its vendor and connects its own account in Settings → Integrations. Manual call-log fallback remains. | Doc 04 §4, doc 09 | Done |
| Q2 | **E-signature vendor?** | ✅ **DECIDED (24-Jul-2026): Zoho Sign.** Connectable per tenant in Settings → Integrations; logged-written-approval fallback remains until an agency connects its account. | Doc 04 §6, doc 05 §4 | Done |
| Q3 | **Accounting tool: Zoho Books or Tally?** | ✅ **DECIDED (24-Jul-2026): Zoho Books.** Per-tenant connection in Settings → Integrations; invoice push + payment-status pull per doc 07 §4. | Doc 07 §4, doc 09 | Done |
| Q4/Q5 | **Integration model** (new requirement, 24-Jul-2026) | ✅ **DECIDED: self-serve integrations hub.** Every marketing-agency API type (lead sources, telephony, WhatsApp/SMS, email, e-sign, accounting, calendar, storage, payments, plus arbitrary Custom APIs) is connectable per tenant at Settings → Integrations. Agencies enter their own credentials (AES-256-GCM encrypted at rest) and activate each integration themselves when their account is production-ready. Zogency never provisions vendor accounts on their behalf. | Doc 02 §6, doc 09 | Done |
